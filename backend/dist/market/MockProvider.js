...
class MockProvider {
    ...
    fluctuatePrices() {
        this.currentMockData.forEach((data, symbol) => {
            ...
            this.currentMockData.set(symbol, Object.assign(Object.assign({}, data), { price: newPrice, change,
                changePercent, volume: data.volume + Math.floor(Math.random() * 500), lastUpdated: new Date() }));
        });
    }
    fetchAllStocks() {
